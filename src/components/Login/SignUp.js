        ...
        <div className="flex h-screen">
            ...
            <div className="lg:overflow-x-hidden lg:w-7/12">
                <div className="lg:mx-24 m-8 lg:my-6">
                    ...
                    <p className="text-xl text-gray-500 mt-3 text-left font-semibold">
                        Let's get started! Fill the form below to sign up
                    </p>
                        ...
                        <div className="form-control w-full">
                            ...
                            <label className="label">
                                {errors.email?.type === 'required' && (
                                    <span className="label-text text-xl text-red-500">
                            ...
                            >
                                ...
                                <option value="Bangladesh" className="text-xl">
                                    India
                                </option>
                                <option value="India" className="text-xl">
                                    Bangladesh
                                </option>
                            </select>
                            <label className="label">
                            ...
                            <input
                                ...
                                {...register('password', {
                                    ...
                                    minLength: {
                                        value: 6,
                                        message:
                                            'Provide a six character or longer',
                                    },
                                })}
                            />
                            <label className="label">
                            ...
                            />
                            <input
                                className="btn btn-primary input-lg w-full my-8 text-white"
                                type="submit"
                                value="Sign Up"
                            />
                            <p className="text-xl">
