    ...
    return (
        <div>
            <div className="flex flex-col gap-2 mb-6">
                <label>
                    Title <span>({`${linkObject.title.length}/25`})</span>
                </label>
                <TextInput
                    value={linkObject.title}
                    onValueChange={(e) =>
                        setLinkObject({ ...linkObject, title: e.target.value })
                    }
            ...
            <div className="flex flex-col gap-2 mb-6">
                ...
                <select
                    value={linkObject.buy}
                    onChange={(e) =>
                        setLinkObject({ ...linkObject, buy: e.target.value })
                    }
            ...
            <div className="flex flex-col gap-2 mb-6">
                ...
                <TextInput
                    ...
                    onValueChange={(e) =>
                        setLinkObject({ ...linkObject, amount: e.target.value })
                    }
