...
export default function PublicView() {
    ...
    useEffect(() => {
        ...
        const linkIndex = state.paymentLinks.findIndex(
            (el) => el.link === linkSlug,
        )
    ...
    const handleCustomAmount = (e) => {
        e.target.checked && setPrice('')

        !e.target.checked && setPrice(link.amount)
                ...
                <div className="absolute top-20 rounded border shadow py-4 px-8 bg-white w-[40vw]">
                    <div className="flex items-start gap-x-8">
                        ...
                        <div>
                            ...
                            <div className="">
                                {link?.description ||
                                    'Aenean sit amet lacus mi. Pellentesque sed dictum odio, et interdum magna. Praesent vehicula nibh sagittis sapien imperdiet, sit amet feugiat enim tincidunt.'}
                            </div>
                        </div>
                    </div>

                    <div className="text-2xl font-medium mt-10">
                        Buy <span> {link?.user.name.split(' ')[0]}</span> a
                        {link?.buy}
                    </div>
                    ...
                    <div className="flex justify-between items-center mt-10">
                        ...
                        <div className="flex border rounded">
                            <button
                                onClick={() => {
                                    amount >= 2 && setAmount(amount - 1)
                                }}
                                className="bg-gray-300 p-2 w-10 rounded"
                            >
                                -
                            </button>
                            <input
                    ...
                    <div className="flex w-full my-8 bg-gray-100 rounded-[24px] text-2xl">
                        <button
                            ...
                            className={`w-1/2 py-2 rounded-[24px] ${
                                type === 'single' && 'btn-primary text-white'
                            } `}
                        >
                            One-time
                        </button>
                        <button
                            ...
                            className={`w-1/2 py-2 rounded-[24px] ${
                                type === 'monthly' && 'btn-primary text-white'
                            }`}
                        >
                            Monthly
                        </button>
                    ...
                    <div>
                        <div className="my-2">
                            <div>Name</div>
                            <input
                                className="border-0 outline-none w-full bg-gray-50 p-3 h-14"
                        ...
                        <div className="my-2">
                            ...
                            <textarea
                                rows="3"
                                className="border-0 outline-none w-full bg-gray-50 p-3"
