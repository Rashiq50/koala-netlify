...
export default function LinkDetails() {
    ...
    useEffect(() => {
        ...
        const productIndex = state.paymentLinks.findIndex(
            (el) => el.link == productId,
        )
            ...
            <div>
                <div className="flex justify-between items-center">
                    <div className="flex gap-4 items-center">
                        ...
                        <a
                            href={`${window.location.origin}/pay/${state.user?.username}/${product?.link}`}
                            target="_"
                        >
                ...
                <div className="my-6">
                    <div className="text-xl my-2 text-gray-600 font-semibold">
                        Stats
                    </div>
                ...
                <div className="mt-10">
                    ...
                    <NoContent
                        ...
                        bottomText={
                            'Hhhmmmm, No one has paid you using this link yet. You can share this link on'
                        }
                    />
                </div>
            </div>
