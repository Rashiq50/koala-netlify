...
const CreateInvoice = () => {
    ...
    const onChange = (e, index) => {
        const updatedItems = items.map((item, i) => index === i ?
            Object.assign(item, { [e.target.name]: e.target.value }) : item)
            ...
            <div className='shadow border-2 px-6 pb-16'>
                    ...
                    <div>
                        <div className="form-control w-96 text-right">
                            <label className="label">
                                <span className="label-text-alt text-xl">Invoice Number</span>
                            </label>
                            <TextInput placeholder={"1234"} />
                            <label className="label">
                                <span className="label-text-alt text-xl">Invoice Title</span>
                            </label>
                            <TextInput placeholder={"Enter the title for this invoice"} />
                            <label className="label">
                                <span className="label-text-alt text-xl">Invoice Description</span>
                            </label>
                            <TextArea placeholder={"E.G project information or service rendered"} />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className="flex justify-between">
                        <div>
                            <label className='text-xl'>Customer Name</label> <br />
                            <TextInput placeholder={"John Doe"} variant={2} />
                        </div>
                        <div>
                            <label className='text-xl'>Customer Email</label> <br />
                            <TextInput type='email' placeholder={"john@gmail.com"} variant={2} />
                        </div>
                    </div>
                    <div className='flex justify-between'>
                        <div>
                            <label className='text-xl'>Invoice Date</label> <br />
                            <DatePicker
                                selected={startDate}
                                ...
                                <div key={index}>
                                    <div className='grid grid-cols-6 gap-4 font-semibold text-gray-600 p-2'>
                                        ...
                                        <input
                                            ...
                                            type='text'
                                            placeholder='NGN: 00' />
                                        <span className='flex justify-center items-center text-red-600 cursor-pointer text-2xl' onClick={() => removeItem(index)}>
                                            <AiOutlineDelete />
                                        </span>
                                    </div>
                                    <hr />
                    ...
                    <div className='flex justify-between'>
                        <div>
                            ...
                            <TextArea placeholder={'...'} rows={"4"} cols={"40"} />
                        ...
                        <div>
                            ...
                            <TextArea placeholder={'Address, Phone Number Or Website'} rows={"4"} cols={"40"} />
                        </div>
                    </div>
                </div>
            </div>
