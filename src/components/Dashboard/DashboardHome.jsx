            ...
            >
                <div className="p-6 w-[600px]">
                    ...
                    <div className="mt-6">
                        <div className="flex gap-4 items-center mb-10 cursor-pointer ">
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="text-gray-500">
                                    Create a payment link to get support from
                                    your fans
                                </div>
                            </div>
                            <div>
                        ...
                        <div
                            onClick={() => navigate('/product-pages/create')}
                        ...
                        >
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="text-gray-500">
                                    Sell your digital products online with Fidia
                                </div>
                            </div>
                            <div>
                                <MdKeyboardArrowRight fontSize={'20px'} />
                        ...
                        <div className="flex gap-4 items-center mb-10 cursor-pointer ">
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="text-gray-500">
                                    Transfer money to your favorite creators for
                                    free on Koala
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="flex gap-4 items-center mb-2 cursor-pointer ">
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="text-gray-500">
                                    Send customizable invoices directly from
