        ...
        <div>
            <div className='flex justify-between justify-items-end py-4 shadow'>
                <div className="relative ml-4 flex items-center rounded bg-gray-100">
                    ...
                    <input type="search" id="default-search" className="p-2 w-96 pl-10 text-sm flex-grow text-gray-900  rounded bg-transparent focus:ring-blue-500 focus:border-blue-500 " placeholder="Search name, type, desc, slug, etc..." required />
