    ...
    return (
        ...
        >
                ...
                <a target={'_'} href={itemLink} className="w-full">
                    <button
                        className={`flex items-center gap-2 ${
                            itemType === 'link' &&
                            'justify-start pl-5 py-2 border-b'
                        } ${
                            itemType === 'product' && 'justify-center p-3'
                        } text-gray-500 font-semibold text-xl ${
                            type === 'vr' && 'hover:bg-gray-200 w-full'
                        }`}
                    >
                        <BsEyeFill />
            ...
            <button
                ...
                className={`flex items-center gap-2 ${
                    itemType === 'link' && 'justify-start pl-5 py-2 border-b'
                } ${
                    itemType === 'product' && 'justify-center p-3'
                } text-gray-500 font-semibold text-xl ${
                    type === 'vr' && 'hover:bg-gray-200 w-full'
            ...
            {itemType !== 'profile' && (
                <button
                    ...
                    className={`flex items-center gap-2 ${
                        itemType === 'link' &&
                        'justify-start pl-5 py-2 border-b text-gray-500'
                    } ${
                        itemType === 'product' &&
                        'justify-center p-3 text-red-500'
                        ...
                        <div>
                            <div className="p-4 flex gap-4 my-4">
                                <a
                                    href="#"
                                    target="_"
                                    className="p-2 text-gray-500 font-semibold text-center"
                                >
                                    <button>
                    ...
                    {modalType === 2 && (
                        <div>
                            <div className="text-gray-700  text-xl my-3">
                                Embed your product pages anywhere on the
                                internet, e.g your blog or website.
                            </div>
